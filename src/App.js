...
function App() {
  ...
  <div class="w-screen max-w-6xl ml-72 mt-8">
                <h2 className='text-6xl font-thin ml-44 underline decoration-from-font decoration-orange-500 underline-offset-8'>Get food fast &mdash; not fast food</h2>
...
<div class="max-w-6xl ml-96">
                <h2 className='text-6xl font-thin ml-16 underline decoration-from-font decoration-orange-500 underline-offset-8' >How it works - Simple as 1, 2, 3</h2>
            </div>
            <div class="max-w-6xl ml-10">
                <div class="ml-80 mt-8">
                    <img className='w-60' src="app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen js--wp-2"/>
                </div>
...
<div class="flex justify-center mt-3">
                <h2  className='text-5xl mt-16 lg:text-6xl font-thin underline decoration-from-font decoration-orange-500 underline-offset-8'>We're currently in these cities</h2>
            </div>
...
<section class="bg-customer">
    <div className='flex justify-center flex-wrap'>
            <div class="max-w-6xl">
                <h2 className='text-5xl lg:text-6xl mt-8 font-thin text-black underline decoration-from-font decoration-orange-500 underline-offset-8' >Our customers can't live without us</h2>
            </div>
            <div class="max-w-7xl flex justify-center items-center">
                <div class="mt-5 ml-2">
                    <blockquote className='leading-6 mt-16 text-black'>
        ...
        <section class="mt-3">
            <div className='flex justify-center flex-wrap '>
            <div class="columns">
                <h2 className='text-5xl lg:text-6xl font-thin ml-20 underline decoration-from-font decoration-orange-500 underline-offset-8'>START EATING HEALTHY TODAY</h2>
            </div>
        ...
        <section class="bg-gray-200">
            <div class="max-w-6xl ml-80">
                <h2 className='text-5xl lg:text-6xl mt-20 ml-20 font-thin underline decoration-from-font decoration-orange-500 underline-offset-8'>We're happy to hear from you</h2>
            </div>
            <div class="max-w-6xl">
                <form class="w-3/5">
